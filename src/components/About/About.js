      ...
      <div id="about-cont">
        ...
        <div>
          ...
          <p className="about-text">
            I’m a Front End Developer based in London (UK), with experience
            building web apps using the most popular library, React.js, for the
            Front End and Node.js + MongoDB in the Back End.
            <br />I have studied a “Full Stack Developer Bootcamp” that gave me
            a deep vision of design and development, where I was able to work
            and team up with the other students. Currently focused on:
            <br />
            ✔️ HTML5 & CSS3 (SASS)
            <br />
            ✔️ JavaScript (ES6)
            <br />
            ✔️ MERN Stack (React, Node, MongoDB, Express)
            <br />
            ✔️ Responsive design
            <br />
            ✔️ Testing (TDD)
            ...
            ✔️ Git
            <br />
            Development is my passion, and I love to create and learn new
            things, I hope to continue creating great projects and helping other
            developers.
          </p>
        </div>
        {/* SERVICES CARDS */}
        <div className="about-card-cont">
          ...
          <div className="about-card">
            ...
            <h3>Front-End</h3>
            <p>
              Fully responsive designs, adaptable to all devices, following the
              latest ECMAScript standard, fast and fresh pages development
            </p>
          </div>
          <div className="about-card border-left">
            ...
            <h3>Back-End</h3>
            <p>
              Server-side applications development, database management in
              MongoDB and application creation using Express
            </p>
          </div>
          <div className="about-card border-left">
            ...
            <h3>Users</h3>
            <p>
              Great capacity for teamwork, use of collaboration tools and
              exchange of ideas with colleagues and communication with clients
            </p>
          </div>
        </div>
        {/* SKILLS TABLE */}
        <div id="skills-cont">
          ...
          <div className="skills-subcont">
            ...
            <div className="skill">
              <img src={JSimg} width="55" height="55" alt="" />{' '}
              <p>JavaScript</p>
            </div>
            <div className="skill">
            ...
            <div className="skill">
              <img src={SHOPIFYimg} width="60" height="60" alt="" />{' '}
              <p>Shopify</p>
            </div>
            <div className="skill">
          ...
          <div className="call-to-action-home">
            <h3>Looking for a new website for your business?</h3>
            <p>
              <span role="img">⭐️</span> CONTACT ME OVER THE FORM TO DISCUSS
              YOUR REQUIREMENTS! <span role="img">⭐️</span>
            </p>
          </div>
        </div>
      </div>
